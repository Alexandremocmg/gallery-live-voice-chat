...
val lightCustomColors =
  CustomColors(
    appTitleGradientColors = listOf(Color(0xFFFF5A4F), Color(0xFF82B493), Color(0xFF6B94E8)),
    tabHeaderBgColor = Color(0xFFF35B50),
    ...
    taskBgGradientColors =
      listOf(
        // red
        listOf(Color(0xFFFF6A5E), Color(0xFFF35B50)),
        // green
        listOf(Color(0xFF9AC5A7), Color(0xFF6FA37D)),
        // blue
        listOf(Color(0xFF91B1F0), Color(0xFF6B94E8)),
        // yellow
        listOf(Color(0xFFF1C56C), Color(0xFFD89D39)),
      ),
    taskIconColors =
      listOf(
        // red.
    ...
    homeBottomGradient = listOf(Color(0x00FFFCF7), Color(0xFFFFFCF7)),
    agentBubbleBgColor = Color(0xFFE3F0E5),
    userBubbleBgColor = Color(0xFFF35B50),
    linkColor = Color(0xFFB33F38),
    successColor = Color(0xFF5E8E73),
    recordButtonBgColor = Color(0xFFF35B50),
    ...
    newFeatureContainerColor = Color(0xFFFFE6D1),
    newFeatureTextColor = Color(0xFF65351F),
    bgStarColor = Color(0x24FF5A4F),
    promoBannerBgBrush =
      Brush.linearGradient(
        colorStops =
          arrayOf(
            0.0f to Color(0x42FFDAD3),
            0.6154f to Color(0x42FFC1B6),
            1.0f to Color(0x42F2A296),
          ),
        start = Offset(0f, 0f),
    ...
    promoBannerIconBgBrush =
      Brush.linearGradient(
        colorStops =
          arrayOf(
            0.2442f to Color(0x3B8E4C42),
            0.4296f to Color(0x3BC95040),
            0.6651f to Color(0x3BFFDAD3),
          ),
        start = Offset(0f, 1f),
        end = Offset(1f, 0f),
      ),
...
val darkCustomColors =
  CustomColors(
    appTitleGradientColors = listOf(Color(0xFFFFB4A8), Color(0xFFA9D0B4), Color(0xFFB9CAFF)),
    tabHeaderBgColor = Color(0xFFB33F38),
    ...
    taskBgGradientColors =
      listOf(
        // red
        listOf(Color(0xFFE58B7D), Color(0xFFC95040)),
        // green
        listOf(Color(0xFF86B99A), Color(0xFF4F8C6D)),
        // blue
        listOf(Color(0xFF9CC4DA), Color(0xFF5C8EA9)),
        // yellow
        listOf(Color(0xFFE8C982), Color(0xFFC7953D)),
      ),
    taskIconColors =
      listOf(
        // red.
    ...
    homeBottomGradient = listOf(Color(0x00101412), Color(0xFF101412)),
    agentBubbleBgColor = Color(0xFF202A24),
    userBubbleBgColor = Color(0xFF912F25),
    linkColor = Color(0xFFFFB4A8),
    successColor = Color(0xFF86B99A),
    recordButtonBgColor = Color(0xFFFFB4A8),
    waveFormBgColor = Color(0xFFaaaaaa),
    modelInfoIconColor = Color(0xFFCCCCCC),
    ...
    newFeatureContainerColor = Color(0xFF5C3529),
    newFeatureTextColor = Color(0xFFFFDCCF),
    bgStarColor = Color(0x24FFB4A8),
    promoBannerBgBrush =
      Brush.linearGradient(
        colorStops = arrayOf(0.0f to Color(0x823E1D1A), 0.8077f to Color(0x821A0E0C)),
        start = Offset(0f, 0f),
        end = Offset(0f, Float.POSITIVE_INFINITY),
      ),
    promoBannerIconBgBrush =
      Brush.linearGradient(
        colorStops =
          arrayOf(
            0.2442f to Color(0x6F6A2118),
            0.4296f to Color(0x6FC95040),
            0.6651f to Color(0x6FFFF0EB),
          ),
        start = Offset(0f, 1f),
        end = Offset(1f, 0f),
      ),
